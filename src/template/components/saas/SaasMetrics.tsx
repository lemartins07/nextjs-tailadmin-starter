        ...
        <div className="border-b border-gray-200 px-6 py-5 sm:border-r sm:border-b-0 dark:border-gray-800">
          <div>
            ...
            <div className="mt-2 flex items-end gap-3">
              ...
              <div>
                <span className="flex items-center gap-1 rounded-full bg-error-50 py-0.5 pr-2.5 pl-2 text-sm font-medium text-error-600 dark:bg-success-500/15 dark:text-error-500">
                  -1.6%
                </span>
              </div>
            </div>
