      ...
      <div className="relative">
        ...
        <div className="relative mb-6 flex">
          ...
          <div className="ml-4">
            ...
            <p className="mt-1 text-theme-xs text-gray-400">Just Now</p>
          </div>
        </div>
        ...
        <div className="relative mb-6 flex">
          ...
          <div className="ml-4">
            ...
            <p className="mt-1 text-theme-xs text-gray-400">15 minutes ago</p>
          </div>
        </div>
        ...
        <div className="relative mb-6 flex">
          <div className="z-10 flex-shrink-0">
            <img
              src="/template/images/user/user-04.jpg"
              alt="Bessie Cooper"
              className="size-10 rounded-full object-cover ring-4 ring-white dark:ring-gray-800"
            />
          </div>
          <div className="ml-4">
            <div className="flex items-baseline">
              ...
              <span className="ml-2 text-theme-sm text-gray-500 dark:text-gray-400">
                created invoice
              </span>
            </div>
            <p className="text-theme-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <p className="mt-1 text-theme-xs text-gray-400">5 months ago</p>
          </div>
        </div>
        ...
        <div className="relative flex">
          ...
          <div className="ml-4">
            ...
            <p className="mt-1 text-theme-xs text-gray-400">2 weeks ago</p>
          </div>
        </div>
      </div>
    </div>
