        ...
        <div className="custom-scrollbar max-h-full space-y-1 overflow-auto">
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-18.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
            </div>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-17.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-19.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-05.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-warning-500 dark:border-gray-900"></span>
            </div>
            <div className="w-full">
              <div className="flex items-start justify-between">
                <div>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-20.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-34.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-35.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-36.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-error-500 dark:border-gray-900"></span>
            </div>
            <div className="w-full">
              <div className="flex items-start justify-between">
                <div>
          ...
          <div className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
            <div className="relative h-12 w-full max-w-[48px] rounded-full">
              <img
                src="/template/images/user/user-37.jpg"
                alt="profile"
                className="h-full w-full overflow-hidden rounded-full object-cover object-center"
              />
              <span className="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
