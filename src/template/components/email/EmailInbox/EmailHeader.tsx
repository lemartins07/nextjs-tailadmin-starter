      ...
      <div className="flex w-full items-center gap-2">
        <div className="relative w-full sm:w-auto">
          ...
          <Dropdown
            ...
            className="absolute top-full left-0 z-40 mt-1 w-40 space-y-1 rounded-2xl border border-gray-200 bg-white p-2 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
          >
            <DropdownItem
        ...
        <button className="flex h-10 w-full max-w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition-colors hover:bg-gray-100 hover:text-error-500 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-error-500">
          <svg
        ...
        <div className="relative inline-block">
          <button
            ...
            className="dropdown-toggle dropdown-toggle flex h-10 w-10 max-w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition-colors hover:bg-gray-100 dark:border-white/[0.05] dark:text-gray-400 dark:hover:bg-gray-800"
          >
