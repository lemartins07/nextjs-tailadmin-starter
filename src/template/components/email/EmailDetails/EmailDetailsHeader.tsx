  ...
  return (
    <div className="flex flex-col justify-between border-b border-gray-200 sm:flex-row dark:border-gray-800">
      <div className="flex w-full items-center justify-between gap-3 px-4 py-4 sm:justify-normal">
        <button className="flex h-10 w-full max-w-10 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-700 transition hover:bg-gray-100 hover:text-gray-800 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-200">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <div className="flex items-center gap-3">
          <div className="flex">
            <button className="flex h-10 w-10 items-center justify-center text-gray-500 ring-1 ring-gray-200 transition ring-inset first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 hover:text-error-500 dark:bg-white/[0.03] dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.05] dark:hover:text-error-500">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
