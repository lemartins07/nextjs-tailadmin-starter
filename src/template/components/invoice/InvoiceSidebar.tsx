      ...
      <div className="relative mb-5 w-full">
        <form>
          ...
          <input
            ...
            className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-3.5 pl-[42px] text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
          />
        </form>
      </div>
      ...
      <div className="space-y-1">
        <div className="flex cursor-pointer items-center gap-3 rounded-lg bg-gray-100 p-2 hover:bg-gray-100 dark:bg-white/[0.03] dark:hover:bg-white/[0.03]">
          <div className="h-12 w-12 overflow-hidden rounded-full">
            <img src="/template/images/user/user-19.jpg" alt="user" />
          </div>
        ...
        <div className="flex cursor-pointer items-center gap-3 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
          <div className="h-12 w-12 overflow-hidden rounded-full">
            <img src="/template/images/user/user-17.jpg" alt="user" />
          </div>
        ...
        <div className="flex cursor-pointer items-center gap-3 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
          <div className="h-12 w-12 overflow-hidden rounded-full">
            <img src="/template/images/user/user-20.jpg" alt="user" />
          </div>
        ...
        <div className="flex cursor-pointer items-center gap-3 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
          <div className="h-12 w-12 overflow-hidden rounded-full">
            <img src="/template/images/user/user-34.jpg" alt="user" />
          </div>
