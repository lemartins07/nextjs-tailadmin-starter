    ...
    <div className="rounded-2xl border border-gray-200 bg-white xl:w-4/5 dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <div className="p-5 xl:p-8">
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <button className="flex items-center justify-center gap-2 rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
            <svg
