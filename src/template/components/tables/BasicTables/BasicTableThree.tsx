          ...
          <Table>
            <TableHeader className="border-y border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                <TableCell
                  isHeader
                  className="py-3 text-start text-theme-sm font-normal text-gray-500 dark:text-gray-400"
                >
                  Name
                </TableCell>
                <TableCell
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {currentItems.map((item, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="px-4 py-4 text-theme-sm text-gray-700 dark:text-gray-400">
                    {item.amount}
                  </TableCell>
                  <TableCell className="px-4 py-4 text-theme-sm text-gray-700 dark:text-gray-400">
                    {item.category}
                ...
                <button
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-lg text-theme-sm font-medium ${
                    currentPage === idx + 1
                      ...
                      : 'text-gray-700 hover:bg-brand-500/[0.08] hover:text-brand-500 dark:text-gray-400 dark:hover:bg-brand-500 dark:hover:text-white'
                  }`}
                >
                  {idx + 1}
                </button>
