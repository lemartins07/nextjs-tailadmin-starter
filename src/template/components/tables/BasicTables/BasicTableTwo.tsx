      ...
      <div className="max-w-full overflow-x-auto">
        <Table>
          <TableHeader className="border-y border-t border-gray-100 bg-gray-50 px-6 py-3.5 dark:border-white/[0.05] dark:bg-gray-900">
            <TableRow>
              <TableCell className="px-6 py-3 text-start text-theme-xs font-medium text-gray-500 sm:px-6 dark:text-gray-400">
                <div className="flex items-center gap-3">
                  <div>
            ...
            {tableRowData.map((row: TableRowData) => (
              <TableRow key={row.id}>
                ...
                <TableCell className="px-4 py-3.5 sm:px-6">
                  {row.actions.delete && (
                    <button>
                      <TrashBinIcon className="size-5 cursor-pointer text-gray-700 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500" />
                    </button>
                  )}
                </TableCell>
              </TableRow>
