          ...
          <Table>
            ...
            <TableBody>
              {currentData.map((item, i) => (
                <TableRow key={i + 1}>
                  <TableCell className="border border-gray-100 px-4 py-4 text-theme-sm font-medium whitespace-nowrap text-gray-800 dark:border-white/[0.05] dark:text-white">
                    {item.name}
                  </TableCell>
                  <TableCell className="border border-gray-100 px-4 py-4 text-theme-sm font-normal whitespace-nowrap text-gray-800 dark:border-white/[0.05] dark:text-gray-400">
                    {item.position}
                  </TableCell>
                  <TableCell className="border border-gray-100 px-4 py-4 text-theme-sm font-normal whitespace-nowrap text-gray-800 dark:border-white/[0.05] dark:text-gray-400">
                    {item.location}
                  ...
                  <TableCell className="border border-gray-100 px-4 py-4 text-theme-sm font-normal whitespace-nowrap text-gray-800 dark:border-white/[0.05] dark:text-white/90">
