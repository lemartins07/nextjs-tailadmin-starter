...
const initialTasks: Task[] = [
  {
    ...
    dueDate: 'Tomorrow',
    comments: 1,
    assignee: '/template/images/user/user-01.jpg',
    status: 'todo',
  ...
  },
  {
    ...
    dueDate: 'Jan 8, 2027',
    assignee: '/template/images/user/user-07.jpg',
    status: 'todo',
  ...
  },
  {
    ...
    dueDate: 'Today',
    comments: 1,
    assignee: '/template/images/user/user-09.jpg',
    status: 'inProgress',
  ...
  },
  {
    ...
    dueDate: 'Jan 08, 2027',
    comments: 8,
    assignee: '/template/images/user/user-10.jpg',
    status: 'inProgress',
  ...
  },
  {
    ...
    projectImg: '/template/images/task/task.png',
    dueDate: 'Today',
    comments: 1,
    assignee: '/template/images/user/user-09.jpg',
    status: 'inProgress',
  ...
  },
  {
    ...
    dueDate: 'Mar 08, 2027',
    comments: 1,
    assignee: '/template/images/user/user-12.jpg',
    status: 'inProgress',
    category: { name: 'Dev', color: 'default' },
  },
  {
    ...
    dueDate: 'Tomorrow',
    comments: 1,
    assignee: '/template/images/user/user-13.jpg',
    status: 'completed',
    category: { name: 'Dev', color: 'default' },
  },
  {
    ...
    dueDate: 'Jan 8, 2027',
    comments: 1,
    assignee: '/template/images/user/user-14.jpg',
    status: 'completed',
    category: { name: 'Development', color: 'orange' },
  },
  {
