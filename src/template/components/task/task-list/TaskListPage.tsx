...
const initialTasks: Task[] = [
  {
    ...
    commentCount: 1,
    category: 'Marketing',
    userAvatar: '/template/images/user/user-01.jpg',
    status: 'todo',
  ...
  },
  {
    ...
    commentCount: 2,
    category: 'Marketing',
    userAvatar: '/template/images/user/user-02.jpg',
    status: 'todo',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    commentCount: 1,
    category: 'Marketing',
    userAvatar: '/template/images/user/user-03.jpg',
    status: 'todo',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    commentCount: 2,
    category: 'Template',
    userAvatar: '/template/images/user/user-04.jpg',
    status: 'in-progress',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    dueDate: 'Jan 8, 2027',
    commentCount: 2,
    userAvatar: '/template/images/user/user-05.jpg',
    status: 'in-progress',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    dueDate: 'Jan 8, 2027',
    commentCount: 2,
    userAvatar: '/template/images/user/user-06.jpg',
    status: 'in-progress',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    dueDate: 'Jan 8, 2027',
    commentCount: 2,
    userAvatar: '/template/images/user/user-07.jpg',
    status: 'in-progress',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    commentCount: 1,
    category: 'Marketing',
    userAvatar: '/template/images/user/user-08.jpg',
    status: 'completed',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    commentCount: 1,
    category: 'Marketing',
    userAvatar: '/template/images/user/user-09.jpg',
    status: 'completed',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    commentCount: 1,
    category: 'Marketing',
    userAvatar: '/template/images/user/user-10.jpg',
    status: 'completed',
    toggleChecked: () => {}, // This will be replaced
  },
  {
    ...
    commentCount: 1,
    category: 'Marketing',
    userAvatar: '/template/images/user/user-11.jpg',
    status: 'completed',
    toggleChecked: () => {}, // This will be replaced
  },
];
  ...
  return (
    <>
      <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div className="mt-7 space-y-8 border-t border-gray-200 p-4 sm:mt-0 xl:p-6 dark:border-gray-800">
          {lanes.map((lane) => (
            <TaskLane
              key={lane}
              lane={lane}
