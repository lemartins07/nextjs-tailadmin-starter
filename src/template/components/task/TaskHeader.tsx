          ...
          <div className="grid grid-cols-2 items-center gap-x-1 gap-y-2 rounded-lg bg-gray-100 p-0.5 sm:grid-cols-4 dark:bg-gray-900">
            {taskGroups.map((group) => (
              ...
              >
                {group.name}
                <span
                  className={`inline-flex rounded-full px-2 py-0.5 text-xs leading-normal font-medium group-hover:bg-brand-50 group-hover:text-brand-500 dark:group-hover:bg-brand-500/15 dark:group-hover:text-brand-400 ${
                    selectedTaskGroup === group.key
          ...
          <div className="custom-scrollbar h-[450px] overflow-y-auto px-2">
            <div className="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="dark:bg-form-input relative z-20 bg-transparent">
                  ...
                  <span className="absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                    <svg
            ...
            <div className="relative mt-6 rounded-xl border border-gray-200 bg-gray-50 p-3 sm:p-5 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="flex flex-col items-center gap-3 sm:flex-row">
                <div className="group relative flex w-full cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-white py-2.5 pr-5 pl-3 sm:w-auto dark:border-gray-800 dark:bg-white/5">
                  <span className="absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-400 opacity-0 group-hover:opacity-100 dark:border-gray-800 dark:bg-gray-900">
                    <svg
                      className="fill-current"
                      width="12"
                      height="12"
                  ...
                  <div className="h-10 w-full max-w-10">
                    <img src="/template/images/task/pdf.svg" alt="icon" />
                  </div>
                  <div>
                ...
                <div className="group relative flex w-full cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-white py-2.5 pr-5 pl-3 sm:w-auto dark:border-gray-800 dark:bg-white/5">
                  ...
                  <div className="h-10 w-full max-w-10">
                    <img
                      src="/template/images/task/google-drive.svg"
                      alt="icon"
                    />
                  </div>
                  <div>
          ...
          <div className="mt-6 flex flex-col items-center gap-6 px-2 sm:flex-row sm:justify-between">
            <div className="flex flex-col items-center gap-3 sm:flex-row">
              ...
              <div className="flex -space-x-2">
                <div className="h-8 w-8 overflow-hidden rounded-full border border-white dark:border-gray-900">
                  <img src="/template/images/user/user-13.jpg" alt="user" />
                </div>
                <div className="h-8 w-8 overflow-hidden rounded-full border border-white dark:border-gray-900">
                  <img src="/template/images/user/user-14.jpg" alt="user" />
                </div>
                <div className="h-8 w-8 overflow-hidden rounded-full border border-white dark:border-gray-900">
                  <img src="/template/images/user/user-15.jpg" alt="user" />
                </div>
              </div>
            </div>
