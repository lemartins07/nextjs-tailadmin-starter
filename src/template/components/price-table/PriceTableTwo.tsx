    ...
    <div className="gird-cols-1 grid gap-5 sm:grid-cols-2 xl:grid-cols-3 xl:gap-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 xl:p-8 dark:border-gray-800 dark:bg-white/[0.03]">
        <div className="-mb-4 flex items-start justify-between">
          ...
          <span className="flex h-[56px] w-[56px] items-center justify-center rounded-[10.5px] bg-brand-50 text-brand-500 dark:bg-brand-500/10">
            <svg
      ...
      {/* <!-- Pricing item --> */}
      <div className="rounded-2xl border-2 border-brand-500 bg-white p-6 xl:p-8 dark:border-brand-500 dark:bg-white/[0.03]">
        <div className="-mb-4 flex items-start justify-between">
          <span className="block text-theme-xl font-semibold text-gray-800 dark:text-white/90">
            Professional
          </span>
