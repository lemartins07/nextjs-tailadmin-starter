    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 sm:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <div>
        <div className="flex items-center justify-between border-b border-gray-100 py-3 last:border-b-0 dark:border-gray-800">
          <div className="flex items-center gap-4">
            <div className="w-full max-w-8 items-center rounded-full">
              <img src="/template/images/brand/brand-05.svg" alt="brand" />
            </div>
            <div>
        ...
        <div className="flex items-center justify-between border-b border-gray-100 py-3 last:border-b-0 dark:border-gray-800">
          <div className="flex items-center gap-4">
            <div className="w-full max-w-8 items-center rounded-full">
              <img src="/template/images/brand/brand-06.svg" alt="brand" />
            </div>
            <div>
              <p className="text-theme-sm font-medium text-gray-700 dark:text-gray-300">
                Youtube
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            <div className="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-gray-800">
              <div className="absolute top-0 left-0 flex h-full w-[55%] items-center justify-center rounded-sm bg-brand-500 text-xs font-medium text-white"></div>
            </div>
            <p className="text-theme-sm font-medium text-gray-700 dark:text-gray-400">
              55%
            </p>
        ...
        <div className="flex items-center justify-between border-b border-gray-100 py-3 last:border-b-0 dark:border-gray-800">
          <div className="flex items-center gap-4">
            <div className="w-full max-w-8 items-center rounded-full">
              <img src="/template/images/brand/brand-02.svg" alt="brand" />
            </div>
            <div>
              <p className="text-theme-sm font-medium text-gray-700 dark:text-gray-300">
                Facebook
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            <div className="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-gray-800">
              <div className="absolute top-0 left-0 flex h-full w-[48%] items-center justify-center rounded-sm bg-brand-500 text-xs font-medium text-white"></div>
            </div>
            <p className="text-theme-sm font-medium text-gray-700 dark:text-gray-400">
              48%
            </p>
        ...
        <div className="flex items-center justify-between border-b border-gray-100 py-3 last:border-b-0 dark:border-gray-800">
          <div className="flex items-center gap-4">
            <div className="w-full max-w-8 items-center rounded-full">
              <img src="/template/images/brand/brand-04.svg" alt="brand" />
            </div>
            <div>
              <p className="text-theme-sm font-medium text-gray-700 dark:text-gray-300">
                Instagram
