  ...
  return (
    <div className="flex items-center gap-10">
      ...
      <div className="group relative inline-block">
        ...
        <div className="invisible absolute bottom-full left-1/2 mb-2.5 -translate-x-1/2 opacity-0 transition-opacity duration-300 group-hover:visible group-hover:opacity-100">
          <div className="relative">
            <div className="rounded-lg bg-white px-3 py-2 text-xs font-medium whitespace-nowrap text-gray-700 drop-shadow-4xl">
              This is a tooltip
            </div>
            <div className="absolute -bottom-1 left-1/2 h-3 w-4 -translate-x-1/2 rotate-45 bg-white drop-shadow-4xl"></div>
          </div>
        </div>
      </div>
      {/* <!-- Dark --> */}
      <div className="group relative inline-block">
        ...
        <div className="invisible absolute bottom-full left-1/2 mb-2.5 -translate-x-1/2 opacity-0 transition-opacity duration-300 group-hover:visible group-hover:opacity-100">
          <div className="relative">
            <div className="rounded-lg bg-[#1E2634] px-3 py-2 text-xs font-medium whitespace-nowrap text-white drop-shadow-4xl">
              This is a tooltip
            </div>
