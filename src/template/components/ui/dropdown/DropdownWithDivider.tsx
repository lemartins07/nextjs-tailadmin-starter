  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="dropdown-toggle inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white hover:bg-brand-600"
      >
        Options
        <svg
      ...
      <Dropdown
        className="absolute top-full left-0 z-40 mt-2 w-full min-w-[260px] rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-[#1E2635]"
        isOpen={isOpen}
