  ...
  return (
    <div className="relative inline-block">
      ...
      {isOpen && (
        ...
        >
          <div className="w-full rounded-xl bg-white shadow-theme-lg dark:bg-[#1E2634]">
            {children}
            <div
              className={`absolute h-3 w-3 bg-white shadow-theme-lg dark:bg-[#1E2634] ${arrowClasses[position]}`}
            ></div>
          </div>
        </div>
      )}
