...
const tableData = [
  {
    ...
    fileIcon: {
      light: '/template/images/icons/file-video.svg',
      dark: '/template/images/icons/file-video-dark.svg',
    },
    category: 'Video',
    size: '89 MB',
  ...
  },
  {
    fileName: 'Travel.jpg',
    fileIcon: {
      light: '/template/images/icons/file-image.svg',
      dark: '/template/images/icons/file-image-dark.svg',
    },
    category: 'Image',
    size: '5.4 MB',
  ...
  },
  {
    ...
    fileIcon: {
      light: '/template/images/icons/file-pdf.svg',
      dark: '/template/images/icons/file-pdf-dark.svg',
    },
    category: 'Document',
    size: '1.2 MB',
        ...
        <table className="w-full table-auto border-collapse">
          ...
          <thead>
            <tr className="border-t border-gray-200 dark:border-gray-800">
              <th className="px-6 py-3 text-left text-theme-sm font-medium text-gray-500 dark:text-gray-400">
                File Name
              </th>
              <th className="px-6 py-3 text-left text-theme-sm font-medium text-gray-500 dark:text-gray-400">
                Category
              ...
              <th className="px-6 py-3 text-center text-theme-sm font-medium text-gray-500 dark:text-gray-400">
                Action
              </th>
            </tr>
          </thead>
          ...
          <tbody>
            {tableData.map((row, index) => (
              ...
              >
                ...
                <td className="px-6 py-[18px] text-theme-sm text-gray-700 dark:text-gray-400">
                  {row.category}
                </td>
                <td className="px-6 py-[18px] text-theme-sm text-gray-700 dark:text-gray-400">
                  {row.size}
