...
const stockData: StockCardProps[] = [
  {
    imgUrl: '/template/images/brand/brand-07.svg',
    symbol: 'APPL',
  ...
  {
    imgUrl: '/template/images/brand/brand-08.svg',
    symbol: 'PYPL',
  ...
  {
    imgUrl: '/template/images/brand/brand-09.svg',
    symbol: 'TSLA',
  ...
  {
    imgUrl: '/template/images/brand/brand-10.svg',
    symbol: 'AMZN',
