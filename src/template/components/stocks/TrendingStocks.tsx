              ...
              <div className="mb-5 flex items-center justify-between border-b border-gray-200 pb-5 dark:border-gray-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10">
                    <img
                      src="/template/images/brand/brand-09.svg"
                      alt="brand"
                    />
                  </div>
            ...
            <div className="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
              <div className="mb-5 flex items-center justify-between border-b border-gray-200 pb-5 dark:border-gray-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10">
                    <img
                      src="/template/images/brand/brand-07.svg"
                      alt="brand"
                    />
                  </div>
            ...
            <div className="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
              <div className="mb-5 flex items-center justify-between border-b border-gray-200 pb-5 dark:border-gray-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10">
                    <img
                      src="/template/images/brand/brand-11.svg"
                      alt="brand"
                    />
                  </div>
            ...
            <div className="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
              <div className="mb-5 flex items-center justify-between border-b border-gray-200 pb-5 dark:border-gray-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10">
                    <img
                      src="/template/images/brand/brand-08.svg"
                      alt="brand"
                    />
                  </div>
            ...
            <div className="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
              <div className="mb-5 flex items-center justify-between border-b border-gray-200 pb-5 dark:border-gray-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10">
                    <img
                      src="/template/images/brand/brand-10.svg"
                      alt="brand"
                    />
                  </div>
