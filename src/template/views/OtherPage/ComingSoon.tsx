          ...
          <div className="mx-auto w-full max-w-[460px] text-center">
            <Link to="/" className="mb-6 inline-block">
              <img
                ...
                src="/template/images/logo/logo.svg"
                alt="Logo"
              />
              <img
                className="hidden dark:block"
                src="/template/images/logo/logo-dark.svg"
                alt="Logo"
              />
            </Link>

            <h1 className="mb-3 text-title-md font-bold text-gray-800 xl:text-title-xl dark:text-white/90">
              Coming Soon
            </h1>
            ...
            <form>
              <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
                ...
                <button
                  type="submit"
                  className="flex w-full items-center justify-center gap-2 rounded-lg bg-gray-800 px-4 py-3 text-sm font-medium text-white hover:bg-brand-600 sm:w-auto dark:bg-brand-500 dark:hover:bg-brand-600"
                >
                  <svg
