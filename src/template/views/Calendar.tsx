...
const createInitialEvents = (): CalendarEvent[] => {
  ...
  return [
    ...
    },
    {
      id: '2',
      title: 'Meeting',
      start: new Date(now + 86400000).toISOString().split('T')[0],
      extendedProps: { calendar: 'Success' },
    },
    {
      id: '3',
      title: 'Workshop',
      start: new Date(now + 172800000).toISOString().split('T')[0],
      end: new Date(now + 259200000).toISOString().split('T')[0],
                      ...
                      >
                        ...
                        >
                          <span className="relative">
                            ...
                            />
                            <span
                              className={`box mr-2 flex h-5 w-5 items-center justify-center rounded-full border border-gray-300 dark:border-gray-700`}
                            >
                              <span
